...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['NowMeee','Safari','1.0.0'],
        auth: state,
        version: getVersionWaweb() || [2, 2204, 13]
    })
  const { version, isLatest } = await fetchLatestBaileysVersion()
	console.log(`VERSI WA v${version.join('.')}, isLatest: ${isLatest}`)
    console.log(color(figlet.textSync('nomiphoria', {
		font: 'Standard',
		horizontalLayout: 'default',
		vertivalLayout: 'default',
		whitespaceBreak: false
	}), 'red'))
	console.log(color('\nselamat datang owner ku', 'yellow'))
...
mediaType:1,
thumbnail: ppusernya,
sourceUrl: `https://www.instagram.com/nomiphoria.__`,
mediaUrl: `https://www.instagram.com/nomiphoria.__`
}}
}
